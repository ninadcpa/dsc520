...
ggplot(heights_df, aes(x=height, y=earn, col=sex)) + geom_point() + geom_smooth()
...
ggplot(heights_df, aes(x=earn)) + geom_histogram(color="darkblue", fill="lightblue")

## Create a histogram of the `earn` variable using `geom_histogram()`
## Use 10 bins
ggplot(heights_df, aes(x=earn)) + geom_histogram(color="darkblue", fill="lightblue",binwidth = 10)
