...
```{r, message=FALSE, warning=FALSE, echo = TRUE}
kable(head(df_consolidated))%>% kable_styling()
kable(head(df_consolidated[,c("state","population_k","total_direct_expenditure","total_justice_system_pc","pp_average_earnings")]), caption="Justice and Legal System - 2016") %>% kable_styling()
```
